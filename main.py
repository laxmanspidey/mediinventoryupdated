...
def getauthenicate(username, password):
    ...
    if not cust_password:
        return False, "Username not found. Please check your username or sign up."
...
def customer(username, password):
    ...
    if auth_status:
        ...
        st.warning(auth_message)  # Display the login error message
...
if __name__ == '__main__':
    ...
    if choice == "Login":
        ...
        if username == 'admin' and password == 'admin':
            ...
            st.warning("Incorrect admin credentials. Please try again.")
